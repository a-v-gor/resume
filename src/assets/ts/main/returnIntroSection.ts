...
export default function returnIntroSection() {
  ...
  introDescription.innerHTML = `
    ...
    <p class="article-block__text">Хорошее знание английского языка позволяет изучать документацию в оригинале и исправлять / уточнять / публиковать на русском языке: <a href="https://developer.mozilla.org/ru/docs/Web/CSS/CSS_grid_layout/Basic_concepts_of_grid_layout" target="_blank" class="article-block__link">статья на сайте mdn</a> (<a href="https://github.com/mdn/translated-content/commit/57534ec7878cb97d33fff3173ca9d138bad4384d#diff-4b597b83b51827bfb8d612bf02c061810c70614513cae30f25ae1cd99ff486ce" target="_blank" class="article-block__link">ссылка на коммит</a>), <a href="https://habr.com/ru/articles/768304/" target="_blank" class="article-block__link">статья</a> об использовании CSS.</p>
    <p class="article-block__text">Внимание к деталям позволяет выполнять работу качественно, а руководящий опыт помогает в командной работе: с одной стороны, четко понимать поставленную руководителем задачу и, с другой стороны, активно участвовать в работе команды. Отзывы обо мне опубликованы в на странице <a href="https://app.rs.school/cv/fb197dd1-e338-4171-9396-e96774f4f200" target="_blank" class="article-block__link">резюме</a> RSSchool.</p>`;
